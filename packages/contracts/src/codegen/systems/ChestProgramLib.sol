...
// equivalent to WorldResourceIdLib.encode({ typeId: RESOURCE_SYSTEM, namespace: "devcon", name: "ChestProgram" }))
ChestProgramType constant chestProgram = ChestProgramType.wrap(
  0x7379646576636f6e0000000000000000436865737450726f6772616d00000000
);
